...
import { Box, Button, Checkbox, MenuItem, Select, styled, Switch, Typography } from '@mui/material'
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography sx={{ color: 'rgba(22,24,35,0.5)', fontSize: '18px', marginTop: '5px' }}>
          ...
          >
            <Box>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <Typography sx={{ fontSize: '13px', color: 'rgba(22, 24, 35, 0.5)' }}>
                  0 / 150
                </Typography>
              </Box>
              <Box
            ...
            <Box sx={{ marginTop: '24px', display: 'flex', alignItems: 'center', gap: '20px' }}>
